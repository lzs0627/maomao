        ...
        $(window).load(function() {    
            ...
            function resizeBg() {
                ...
                if ( (theWindow.width() / theWindow.height()) < aspectRatio ) {
                    $bg.css({height:theWindow.height(),width:'auto'});
                } else {
                    $bg.css({height:'auto',width:theWindow.width()});
                }
                $(".topimgbg li").css({width:theWindow.width(),height:theWindow.height()});
                $(".content,.panel").css({'min-height':theWindow.height()});
